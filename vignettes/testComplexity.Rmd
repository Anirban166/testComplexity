---
title: "testComplexity vignette"
author: "Anirban Chetia"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{testComplexity vignette}
...
-------------------------------------------------------------------------------------------------
That sums up the functionality offered by testComplexity `0.0.0.9000`. For more examples, please check the articles section of the [website](https://anirban166.github.io/testComplexity/).
