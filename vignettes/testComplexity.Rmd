...
```{r echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/Anirban166/testComplexity/master/Images/TransparentLogoV5.png")
```

-------------------------------------------------------------------------------------------------

This segment has been written with the intent to provide the user a general introduction to the features and functionality of the package via a set of textual elucidations and with an example discussed throughout for each of the user-oriented functions.
